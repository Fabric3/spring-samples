...
public class ObjectFactory {
    ...
    private final static QName _Divide_QNAME = new QName("http://calculator.ws.samples.fabric3.org/", "divide");
    private final static QName _Multiply_QNAME = new QName("http://calculator.ws.samples.fabric3.org/", "multiply");
    private final static QName _Add_QNAME = new QName("http://calculator.ws.samples.fabric3.org/", "add");
    private final static QName _DivideResponse_QNAME = new QName("http://calculator.ws.samples.fabric3.org/", "divideResponse");
    private final static QName _SubtractResponse_QNAME = new QName("http://calculator.ws.samples.fabric3.org/", "subtractResponse");
    private final static QName _Subtract_QNAME = new QName("http://calculator.ws.samples.fabric3.org/", "subtract");
    private final static QName _AddResponse_QNAME = new QName("http://calculator.ws.samples.fabric3.org/", "addResponse");
    private final static QName _MultiplyResponse_QNAME = new QName("http://calculator.ws.samples.fabric3.org/", "multiplyResponse");
